...
class BackgroundLocator {
  ...
  static Future<void> registerLocationUpdate(void Function(Map<String, dynamic>) callback,
  ...
  static Future<bool> isLocationTracking() async {
    return (await _channel.invokeMethod<bool>(Keys.METHOD_PLUGIN_IS_LOCATION_TRACKING))!;
  }

  static Future<TrackingMode?> currentTrackingMode() async {
    var result = await _channel.invokeMethod<int>(Keys.METHOD_PLUGIN_CURRENT_TRACKING_MODE);
    return result != null ? TrackingMode.getById(result) : null;
  }
